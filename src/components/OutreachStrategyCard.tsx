...
export const OutreachStrategyCard: React.FC<OutreachStrategyCardProps> = ({ outreach }) => {
  ...
  return (
    <div id="outreach" className="bg-white border border-blue-100 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6 scroll-mt-20">
      {/* Header */}
          ...
          <div>
            <div className="flex items-center space-x-2.5">
              ...
              <h3 className="text-xl sm:text-2xl font-extrabold text-slate-900 tracking-tight">
                Candidate Outreach & Messaging Strategy
              </h3>
            </div>
            <p className="text-sm text-slate-500 font-medium mt-1">
              High-conversion value proposition hooks and 3-paragraph cold InMail template
            </p>
          </div>
        </div>
